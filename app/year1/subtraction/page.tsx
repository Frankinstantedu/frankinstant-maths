...
// Subtraction within 20 suitable for early primary learners
function generateQuestion() {
  const a = Math.floor(Math.random() * 11) + 10; // Start with a number between 10 and 20
  const b = Math.floor(Math.random() * (a - 1)) + 1; // Subtract a smaller number
...
export default function SubtractionPage() {
  ...
  // Auto-focus input when modals are closed
  useEffect(() => {

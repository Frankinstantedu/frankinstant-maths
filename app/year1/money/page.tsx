...
interface MoneyQuestion {
  question: string;
  answer: string;
  validAnswers: string[]; // Flexible answers for young learners (e.g. "10", "10p", "10 pence")
}

function generateQuestion(): MoneyQuestion {
  const questions: MoneyQuestion[] = [
    ...
    },
    {
      ...
      answer: "50p",
      validAnswers: ["50", "50p", "50 pence"],
    },
    {
      question: "What is 50p + 10p?",
      answer: "60p",
      validAnswers: ["60", "60p", "60 pence"],
    },
    {
      question: "A toy costs 40p. You pay 50p. How much change?",
      answer: "10p",
      validAnswers: ["10", "10p", "10 pence"],
    },
    {
      question: "Which is more: 70p or 30p?",
      answer: "70p",
      validAnswers: ["70", "70p", "70 pence"],
    },
    {
      question: "What is 10p + 10p + 10p?",
      answer: "30p",
      validAnswers: ["30", "30p", "30 pence"],
    },
    {
      question: "A pencil costs 30p. You pay 50p. How much change?",
      answer: "20p",
      validAnswers: ["20", "20p", "20 pence"],
    },
  ];
        ...
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center p-4 z-50 animate-fade-in">
          ...
          >
            ...
            <p className="text-gray-700 text-lg mb-6">
              {isCorrect ? (
                "You are great at counting money!"
              ) : (
                <>
                  Not quite. <br />
